            ...
            <div className="bg-white p-6 rounded-lg shadow-md mb-6">
                ...
                <table className="w-full border-collapse mb-4">
                    ...
                    <tr>
                        ...
                        <td className="border p-2">Schnittstelle zum Anwendungsprogramm</td>
                        <td className="border p-2">HTTP, FTP, SMTP</td>
                    </tr>
                    <tr>
                        <td className="border p-2">6</td>
                        <td className="border p-2">Presentation</td>
                        <td className="border p-2">Datenformate und Verschlüsselung</td>
                        <td className="border p-2">ASCII, JPEG, MPEG</td>
                    </tr>
                    <tr>
                        <td className="border p-2">5</td>
                        <td className="border p-2">Session</td>
                        <td className="border p-2">Synchronisiert Benutzeraufgaben</td>
                        <td className="border p-2">RPC, NetBIOS</td>
                    </tr>
                    <tr>
                        <td className="border p-2">4</td>
                        <td className="border p-2">Transport</td>
                        <td className="border p-2">Fehlerfreie Übertragung</td>
                        <td className="border p-2">TCP, UDP</td>
                    </tr>
                    <tr>
                        <td className="border p-2">3</td>
                        <td className="border p-2">Network</td>
                        <td className="border p-2">Festlegung der Routen</td>
                        <td className="border p-2">IP, ICMP</td>
                    </tr>
                    <tr>
                        <td className="border p-2">2</td>
                        <td className="border p-2">Data Link</td>
                        <td className="border p-2">Verpackt Rohbits in Rahmen</td>
                        <td className="border p-2">Ethernet, WLAN</td>
                    </tr>
                    <tr>
                        <td className="border p-2">1</td>
                        <td className="border p-2">Physical</td>
                        <td className="border p-2">Physikalische Verbindung</td>
                        <td className="border p-2">Kabel, Stecker</td>
                    </tr>
                    </tbody>
                </table>
